...
(19, 2, 'Pooja Agarwal',     'pooja.agarwal@brightfinserv.com','9876500019','$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'active'),
(20, 2, 'Nikhil Chatterjee', 'nikhil.c@brightfinserv.com',    '9876500020', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'active'),
(21, 2, 'Sanya Kapoor',      'sanya.kapoor@brightfinserv.com','9876500021', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'active'),
(22, 2, 'Rahul Bose',        'rahul.bose@brightfinserv.com',  '9876500022', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'active'),
(23, 2, 'Ishita Sen',        'ishita.sen@brightfinserv.com',  '9876500023', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'active'),
(24, 2, 'Aman Tripathi',     'aman.tripathi@brightfinserv.com','9876500024','$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'active'),
(25, 2, 'Deepika Suresh',    'deepika.s@brightfinserv.com',   '9876500025', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'active'),
(26, 2, 'Varun Malhotra',    'varun.m@brightfinserv.com',     '9876500026', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'active'),
(27, 2, 'Shreya Iyengar',    'shreya.i@brightfinserv.com',    '9876500027', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'active'),
(28, 2, 'Harsh Vardhan',     'harsh.v@brightfinserv.com',     '9876500028', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'active'),
(29, 2, 'Tanvi Kulkarni',    'tanvi.k@brightfinserv.com',     '9876500029', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'inactive'),
(30, 2, 'Yash Malhotra',     'yash.malhotra@brightfinserv.com','9876500030','$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'employee', 'active');
...
(1, 2,  1, 'Indiranagar, Bengaluru',   12.9716, 77.6412, 'Novatech Campus, Whitefield', 12.9698, 77.7500, CURDATE() + INTERVAL 1 DAY, '09:00:00', 2, 3, 85.00, 0, 'published'),
(2, 4,  2, 'Koramangala, Bengaluru',   12.9352, 77.6146, 'Novatech Campus, Whitefield', 12.9698, 77.7500, CURDATE() + INTERVAL 1 DAY, '08:45:00', 2, 3, 90.00, 1, 'published'),
(3, 6,  3, 'HSR Layout, Bengaluru',    12.9121, 77.6446, 'Novatech Campus, Whitefield', 12.9698, 77.7500, CURDATE() + INTERVAL 2 DAY, '09:15:00', 2, 4, 75.00, 0, 'published'),
(4, 8,  4, 'Electronic City, Bengaluru', 12.8452, 77.6602, 'Novatech Campus, Whitefield', 12.9698, 77.7500, CURDATE() - INTERVAL 1 DAY, '08:30:00', 0, 5, 95.00, 0, 'full'),
(5, 10, 5, 'Marathahalli, Bengaluru',  12.9569, 77.7011, 'Novatech Campus, Whitefield', 12.9698, 77.7500, CURDATE(), '08:50:00', 2, 3, 60.00, 0, 'published'),
(6, 17, 6, 'Salt Lake, Kolkata',       22.5727, 88.4310, 'Bright Finserv Tower, Sector V', 22.5697, 88.4297, CURDATE() + INTERVAL 1 DAY, '09:00:00', 3, 4, 65.00, 1, 'published'),
(7, 19, 7, 'New Town, Kolkata',        22.5809, 88.4650, 'Bright Finserv Tower, Sector V', 22.5697, 88.4297, CURDATE() + INTERVAL 1 DAY, '09:10:00', 2, 3, 55.00, 0, 'published'),
(8, 22, 8, 'Park Street, Kolkata',     22.5535, 88.3527, 'Bright Finserv Tower, Sector V', 22.5697, 88.4297, CURDATE() - INTERVAL 2 DAY, '08:40:00', 0, 4, 70.00, 0, 'expired');
...
(1, 1, 3,  1, 85.00,  'booked',            NOW() - INTERVAL 2 HOUR, NULL, NULL),
(2, 2, 5,  1, 90.00,  'booked',            NOW() - INTERVAL 1 HOUR, NULL, NULL),
(3, 3, 7,  2, 150.00, 'booked',            NOW() - INTERVAL 3 HOUR, NULL, NULL),
(4, 4, 9,  2, 190.00, 'trip_completed',    NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 23 HOUR),
(5, 4, 11, 3, 285.00, 'payment_completed', NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 23 HOUR),
(6, 5, 13, 1, 60.00,  'trip_in_progress',  NOW() - INTERVAL 30 MINUTE, NOW() - INTERVAL 10 MINUTE, NULL),
(7, 6, 20, 1, 65.00,  'booked',            NOW() - INTERVAL 1 HOUR, NULL, NULL),
(8, 8, 23, 4, 280.00, 'payment_completed', NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 47 HOUR);
...
(1,  1, 'recharge', 500.00, 'pay_test_rzp_0001', NOW() - INTERVAL 5 DAY),
(2,  1, 'debit',    250.00, 'booking_ref_0001',  NOW() - INTERVAL 4 DAY),
(3,  2, 'recharge', 200.00, 'pay_test_rzp_0002', NOW() - INTERVAL 5 DAY),
(4,  2, 'debit',    80.00,  'booking_ref_0002',  NOW() - INTERVAL 4 DAY),
(5,  3, 'recharge', 400.00, 'pay_test_rzp_0003', NOW() - INTERVAL 6 DAY),
(6,  3, 'debit',    59.50,  'booking_ref_0003',  NOW() - INTERVAL 4 DAY),
(7,  5, 'recharge', 500.00, 'pay_test_rzp_0004', NOW() - INTERVAL 5 DAY),
(8,  5, 'debit',    85.00,  'booking_ref_0004',  NOW() - INTERVAL 1 DAY),
(9,  9, 'recharge', 500.00, 'pay_test_rzp_0005', NOW() - INTERVAL 7 DAY),
(10, 10, 'recharge', 200.00, 'pay_test_rzp_0006', NOW() - INTERVAL 3 DAY),
(11, 10, 'debit',    24.75,  'booking_ref_0005',  NOW() - INTERVAL 2 DAY),
(12, 6, 'recharge',  90.00,  'pay_test_rzp_0007', NOW() - INTERVAL 2 DAY);
...
(1, 4, 190.00, 'upi',    'pay_test_9AbC1234', 'success', NOW() - INTERVAL 23 HOUR),
(2, 5, 285.00, 'wallet', NULL,                 'success', NOW() - INTERVAL 23 HOUR),
(3, 8, 280.00, 'card',   'pay_test_9AbC5678', 'success', NOW() - INTERVAL 47 HOUR),
